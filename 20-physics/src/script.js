...
const world = new CANNON.World() //creating a cannon world
world.gravity.set(0, -9.82, 0) // setting up the world gravity
...
const createShpere = (radius, position) =>
{
    ...
    objectsToUpdate.push({ /** objectsToUpdate.push({mesh, body}) */
        mesh: mesh,
        body: body
    })
}
